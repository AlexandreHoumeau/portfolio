...
export const AboutMe: FC = () => {
  return (
    <div className="bg-fuchsia-300 xl:grid grid-cols-2 z-10 lg:p-0 p-2 flex flex-col justify-center items-center transition-all duration-300 h-[calc(100vh_-_72px)] sm:h-[calc(100vh_-_102px)]">
      <div className="justify-center flex items-center">
        <div className="space-y-8 w-4/5">
          ...
          <div className="font-Courier space-y-4 xl:text-left text-center text-base md:text-2xl">
            <div>
      ...
      <div className="justify-center lg:px-20 px-5 xl:mt-0 mt-20 flex items-center">
