...
export const Experience: FC = () => {
  return (
    <div className="2xl:grid relative grid-cols-2 z-10 lg:p-0 p-2 flex flex-col-reverse	 justify-center items-center transition-all bg-green-400 duration-300  h-[100vh] ">
